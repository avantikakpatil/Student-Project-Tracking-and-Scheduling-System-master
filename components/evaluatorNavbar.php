        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-middle" id="menu">
            ...
            <!-- <li class="nav-item pb-3">
                <a href="project_evaluation_sheet.php?user_id=<?php echo $user_id; ?>" class="nav-link align-middle px-0">
                    <i class="fa-solid fa-square-plus fs-2" style="color: white" data-bs-toggle="tooltip" data-bs-placement="right" title="Project Evaluations"></i><span class="ms-1 d-none d-sm-inline"></span>
                </a>
            </li> -->
        </ul>
        <hr>
